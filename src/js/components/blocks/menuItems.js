    ...
    this.selectors.forEach((value) => {
      switch (value) {
        case selector.PLAY_BUTTON:
          new LinkedButton(this.menu, selector.PLAY_BUTTON, 'Play', undefined);
          break;

        case selector.HELP_BUTTON:
          new LinkedButton(this.menu, selector.HELP_BUTTON, 'Help', undefined);

          break;

        case selector.LOGIN_BUTTON:
          new LinkedButton(this.menu, selector.LOGIN_BUTTON, 'Login', undefined);
          break;

        case selector.SIGN_UP_BUTTON:
          new LinkedButton(this.menu, selector.SIGN_UP_BUTTON, 'Signup', undefined);
          break;
        ...
        case selector.LEADER_BOARD_BUTTON:
          new LinkedButton(this.menu, selector.LEADER_BOARD_BUTTON, 'LeaderBoard', undefined);
          break;
      }
    });
  }
