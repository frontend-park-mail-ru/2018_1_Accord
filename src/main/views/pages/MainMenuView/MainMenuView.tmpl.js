;(function(){var x=Function('return this')();if(!x.fest)x.fest={};x.fest['main/views/pages/MainMenuView/MainMenuView.tmpl']=function (__fest_context){"use strict";var __fest_self=this,__fest_buf="",__fest_chunks=[],__fest_chunk,__fest_attrs=[],__fest_select,__fest_if,__fest_iterator,__fest_to,__fest_fn,__fest_html="",__fest_blocks={},__fest_params,__fest_element,__fest_debug_file="",__fest_debug_line="",__fest_debug_block="",__fest_element_stack = [],__fest_short_tags = {"area": true, "base": true, "br": true, "col": true, "command": true, "embed": true, "hr": true, "img": true, "input": true, "keygen": true, "link": true, "meta": true, "param": true, "source": true, "wbr": true},__fest_jschars = /[\\'"\/\n\r\t\b\f<>]/g,__fest_jschars_test = /[\\'"\/\n\r\t\b\f<>]/,__fest_htmlchars = /[&<>"]/g,__fest_htmlchars_test = /[&<>"]/,__fest_jshash = {"\"": "\\\"", "\\": "\\\\", "/": "\\/", "\n": "\\n", "\r": "\\r", "\t": "\\t", "\b": "\\b", "\f": "\\f", "'": "\\'", "<": "\\u003C", ">": "\\u003E"},__fest_htmlhash = {"&": "&amp;", "<": "&lt;", ">": "&gt;", "\"": "&quot;"},__fest_escapeJS = function __fest_escapeJS(value) {
		...
		fn.param = true;
		return fn;
	},i18n=__fest_self && typeof __fest_self.i18n === "function" ? __fest_self.i18n : function (str) {return str;},___fest_log_error;if(typeof __fest_error === "undefined"){___fest_log_error = (typeof console !== "undefined" && console.error) ? function(){return Function.prototype.apply.call(console.error, console, arguments)} : function(){};}else{___fest_log_error=__fest_error};function __fest_log_error(msg){___fest_log_error(msg+"\nin block \""+__fest_debug_block+"\" at line: "+__fest_debug_line+"\nfile: "+__fest_debug_file)}function __fest_call(fn, params,cp){if(cp)for(var i in params)if(typeof params[i]=="function"&&params[i].param)params[i]=params[i]();return fn.call(__fest_self,params)}__fest_buf+=("<div class=\"view menu-view\">");(function(__fest_context){__fest_buf+=("<div class=\"nav__bar topmenu\"><div class=\"topmenu__buttons-left_container\"><div class=\"back-button topmenu__button topmenu__button-back\"><a></a></div></div><div class=\"topmenu_user__left-position\"><div class=\"profile-button topmenu__user__avatar\"><a></a></div></div><div class=\"topmenu__buttons-right_container\"><div class=\"mute-button topmenu__button topmenu__button-mute m-unmuted\"></div><div class=\"settings-button topmenu__button topmenu__button-settings\"><a></a></div></div></div>");})(__fest_context);__fest_buf+=("<div class=\"menu bubbles\"><div class=\"menu-center-block\"><div class=\"main__menu-items lowermenu\"><div class=\"main__menu-error title-error\" style=\"display: none\"></div><div class=\"main__title title\">Donuts Wars</div><div class=\"play-button mainmenu__button-play\" style=\"display: none\"><a></a></div><div class=\"leader-board-button mainmenu__button\" style=\"display: none\"><a></a></div><div class=\"login-button mainmenu__button\" style=\"display: none\"><a></a></div><div class=\"sign-up-button mainmenu__button\" style=\"display: none\"><a></a></div><div class=\"help-button mainmenu__button\" style=\"display: none\"><a></a></div><div class=\"logout-button mainmenu__button\" style=\"display: none\"></div></div></div></div></div>");__fest_to=__fest_chunks.length;if (__fest_to) {__fest_iterator = 0;for (;__fest_iterator<__fest_to;__fest_iterator++) {__fest_chunk=__fest_chunks[__fest_iterator];if (typeof __fest_chunk==="string") {__fest_html+=__fest_chunk;} else {__fest_fn=__fest_blocks[__fest_chunk.name];if (__fest_fn) __fest_html+=__fest_call(__fest_fn,__fest_chunk.params,__fest_chunk.cp);}}return __fest_html+__fest_buf;} else {return __fest_buf;}}})();