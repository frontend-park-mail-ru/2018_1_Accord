(function () {
  ...
  x.fest['js/components/pages/LeaderBoard.tmpl'] = function (__fest_context) {
    ...
    var __fest_self = this, __fest_buf = '', __fest_chunks = [], __fest_chunk, __fest_attrs = [], __fest_select,
      ...
      __fest_element, __fest_debug_file = '', __fest_debug_line = '', __fest_debug_block = '',
      __fest_element_stack = [], __fest_short_tags = {
        'area': true,
        'base': true,
        'br': true,
        'col': true,
      ...
      __fest_htmlchars = /[&<>"]/g, __fest_htmlchars_test = /[&<>"]/, __fest_jshash = {
        '"': '\\"',
        '\\': '\\\\',
        '/': '\\/',
        '\n': '\\n',
